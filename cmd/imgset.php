...
function cmd_imgset( $params )
{
	...
	if ( ( $params[1] < 1000 && !file_exists( '/secondhand/home/default/www.default.lv/img/chat/faces/'.$params[1].'.gif' ) ) || !query_test( 'select 1 from c4_images where id='.$params[1].' && uid='.$this->uid ) ) return 'Картинки с таким номером не имеется';
	$this->img = $params[1];
